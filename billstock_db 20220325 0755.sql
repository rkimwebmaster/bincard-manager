...
-- Script date 3/25/2022 7:55:14 AM
...
CREATE TABLE bill_rannuel_site (
  ...
  quantite_sortie DOUBLE NOT NULL,
...
--
-- Create index `IDX_B7FD20791DFBCC46` on table `bill_rannuel_site`
--
ALTER TABLE bill_rannuel_site 
  ADD INDEX IDX_B7FD20791DFBCC46(rapport_id);
...
--
ALTER TABLE bill_rannuel_site 
  ADD CONSTRAINT FK_B7FD20791DFBCC46 FOREIGN KEY (rapport_id)
