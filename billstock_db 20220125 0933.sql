...
-- Script date 1/25/2022 9:33:38 AM
...
-- 
-- Dumping data for table bill_ville
--
-- Table billstock_db.bill_ville does not contain any data (it is empty)

-- 
-- Dumping data for table bill_client
--
-- Table billstock_db.bill_client does not contain any data (it is empty)

-- 
-- Dumping data for table bill_site
--
-- Table billstock_db.bill_site does not contain any data (it is empty)

-- 
-- Dumping data for table bill_user
--
-- Table billstock_db.bill_user does not contain any data (it is empty)

-- 
-- Dumping data for table bill_produit
--
-- Table billstock_db.bill_produit does not contain any data (it is empty)

-- 
-- Dumping data for table bill_transfert
--
-- Table billstock_db.bill_transfert does not contain any data (it is empty)

-- 
-- Dumping data for table bill_produit_site
--
-- Table billstock_db.bill_produit_site does not contain any data (it is empty)

-- 
-- Dumping data for table bill_fournisseur
--
-- Table billstock_db.bill_fournisseur does not contain any data (it is empty)

-- 
-- Dumping data for table bill_ligne_transfert
--
-- Table billstock_db.bill_ligne_transfert does not contain any data (it is empty)

-- 
-- Dumping data for table bill_sortie
--
-- Table billstock_db.bill_sortie does not contain any data (it is empty)

-- 
-- Dumping data for table bill_entree
--
-- Table billstock_db.bill_entree does not contain any data (it is empty)

-- 
-- Dumping data for table bill_ligne_billcard
--
-- Table billstock_db.bill_ligne_billcard does not contain any data (it is empty)

-- 
-- Dumping data for table bill_controle
--
-- Table billstock_db.bill_controle does not contain any data (it is empty)

-- 
-- Dumping data for table user_site
--
-- Table billstock_db.user_site does not contain any data (it is empty)

-- 
-- Dumping data for table bill_ligne_sortie
--
-- Table billstock_db.bill_ligne_sortie does not contain any data (it is empty)

-- 
-- Dumping data for table bill_ligne_entree
--
-- Table billstock_db.bill_ligne_entree does not contain any data (it is empty)

-- 
-- Dumping data for table bill_ligne_controle
--
-- Table billstock_db.bill_ligne_controle does not contain any data (it is empty)

-- 
-- Dumping data for table bill_identite
--
-- Table billstock_db.bill_identite does not contain any data (it is empty)
