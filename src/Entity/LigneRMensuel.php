...
/**
 * @ORM\Table(name="bill_ligne_rmensuel")
 * @ORM\Entity(repositoryClass=LigneRMensuelRepository::class)
...
class LigneRMensuel
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity=RMensuelSite::class, inversedBy="ligneRMensuels")
     * @ORM\JoinColumn(nullable=false)
     */
    private $rMensuelSite;
...
$totalSortie= 
    ...
    public function getRMensuelSite(): ?RMensuelSite
    {
        return $this->rMensuelSite;
    }

    public function setRMensuelSite(?RMensuelSite $rMensuelSite): self
    {
        $this->rMensuelSite = $rMensuelSite;
